                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <button type="button" href="/agregar_usuarios" style="right:inherit" class="btn btn-secondary" data-toggle="modal" data-target="#modalNuevo">
                              <a href="/agregar_personas"> <i class="icon-plus"> </i>&nbsp;Nuevo </a>
                        </button>
                    </div>
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>Maria Fernanda Baez Zapata</td>
                                    <td>Colonia los pinos</td>
                                    <td>1456789</td>
                                    <td>2345@upv.edu.mx</td>
                                </tr>
                                <tr>
                                    <td>
                                        <button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#modalNuevo">
                                    ...
                                    <td>Linda Rodriguez Teran</td>
                                    <td>Colonia los patos</td>
                                    <td>1456789</td>
                                    <td>2345@upv.edu.mx</td>
                                </tr>
                                <tr>
                                    ...
                                    <td>Maria del rocio</td>
                                    <td>Colonia los pajaros</td>
                                    <td>1456789</td>
                                    <td>2345@upv.edu.mx</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>Jose Rodolfo Torres</td>
                                    <td>Colonia los reos</td>
                                    <td>1456789</td>
                                    <td>2345@upv.edu.mx</td>
                                </tr>
                            </tbody>
