            ...
            <nav class="sidebar-nav">
                <ul class="nav">
                    ...
                    <li class="nav-item nav-dropdown">
                        <a class="nav-link nav-dropdown-toggle" href="/usuarios"><i class="icon-user"></i> Usuarios</a>
                    ...
                    <li class="nav-item nav-dropdown">
                        <a class="nav-link nav-dropdown-toggle" href="/personas"><i class="icon-wallet"></i> Personas</a>
                        <ul class="nav-dropdown-items">
                            <li class="nav-item">
                    ...
                    <li class="nav-item nav-dropdown">
                        <a class="nav-link nav-dropdown-toggle" href="/roles"><i class="icon-basket"></i> Roles</a>
                        <ul class="nav-dropdown-items">
                            <li class="nav-item">
